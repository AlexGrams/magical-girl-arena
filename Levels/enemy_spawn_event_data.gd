...
## The ending time of this event. If blank, then the event is instant.
...
## The inclusive minimum number of enemies to spawn each time this event repeats.
## The number of enemies created is chosen uniformily at random from this range.
@export var min_spawn_count: int = 1
## The inclusive maximum number of enemies to spawn each time this event repeats. If this is less than
## [param min_spawn_count], then this will be treated as equal to [param min_spawn_count].
